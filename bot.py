...
async def send_welcome(uid, fname):
    ...
    text = (
        ...
        f"🧹 <b>Clean-Up စနစ်:</b> Member အသစ်ဝင်/ထွက် Noti စာကြောင်းများကို သန့်ရှင်းပေးပါသည်။ (Pin Noti များကို မဖျက်ပါ)\n"
...
async def handle_group_messages(message: types.Message):
    ...
    # -------------------------------------------------------------
    # 🧹 ၁။ NOTIFICATION စာကြောင်းများ ဖျက်ခြင်း (Pin Noti မှလွဲ၍ ကျန်တာအကုန်ဖျက်မည်)
    # -------------------------------------------------------------
    is_notification = any([
        message.new_chat_members,
        message.left_chat_member,
        # message.pinned_message ဖြုတ်ထားသဖြင့် Pin Noti များကို ဖျက်မည်မဟုတ်ပါ
